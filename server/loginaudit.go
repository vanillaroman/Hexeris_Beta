...
const (
	...
	// The password fitted but the second factor did not. A separate outcome rather
	// than bad_credentials: this is exactly the row that reveals a stolen password,
	// and it must not be mixed with ordinary typos.
	login2FABad = "bad_totp"
)
